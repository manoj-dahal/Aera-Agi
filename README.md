...
[![tests](https://img.shields.io/badge/tests-2128%20passing-brightgreen)]()
...
137 REST operations plus a WebSocket gateway. Every response uses a consistent
envelope.
...
GET  /api/v1/voice/personas       two bundled voices + user-added
POST /api/v1/voice/voices         register a Piper .onnx as a voice
...
```bash
./scripts/test.sh                    # 2,128 Python tests, then ruff
...
| REST API (137 operations) + WebSocket | ✅ complete |
